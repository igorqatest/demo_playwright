...
test('Shopping only Primary', async ({ page, context }) => {
  ...
  await page.goto('https://brella--staging.sandbox.lightning.force.com/lightning/r/Contract/800U700000FDTgHIAX/view?ws=%2Flightning%2Fr%2FAccount%2F001U700000LYGxfIAH%2Fview');
