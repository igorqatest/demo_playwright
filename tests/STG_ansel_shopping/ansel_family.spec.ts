...
test('Shopping only Primary', async ({ page, context }) => {
  ...
  await page.goto('https://brella--staging.sandbox.lightning.force.com/lightning/r/Contract/800U700000EugHSIAZ/view?ws=%2Flightning%2Fr%2FQuote%2F0Q0U70000026J5FKAU%2Fview');
...
await newPage.getByText('My family and me').click();
...
await newPage.getByRole('textbox', { name: 'XXX-XX-XXXX' }).fill(randomSSN);
console.log(`✅ SSN for Jane: ${randomSSN}`);
